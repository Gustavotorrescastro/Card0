    ...
    <div className="w-full max-w-md p-8 bg-edenred-surface rounded-xl shadow-2xl border border-edenred-border">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label htmlFor="email" className="block text-sm font-semibold text-edenred-text">
            Email
          </label>
          <input
            type="email"
        ...
        <div className="space-y-2">
          <label htmlFor="password" className="block text-sm font-semibold text-edenred-text">
            Senha
          </label>
          <input
            type="password"
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full py-3 rounded-lg font-bold text-white transition-all transform active:scale-95 ${loading
              ? 'bg-gray-400 cursor-not-allowed'
              : 'bg-edenred-primary hover:bg-edenred-secondary shadow-md hover:shadow-lg'
            }`}
        >
          {loading ? (
        ...
        <div className="pt-4 border-t border-edenred-border text-center">
          <p className="text-[10px] uppercase tracking-wider text-edenred-textSecondary mb-2 font-bold">
            Credenciais de Acesso
          </p>
          <div className="bg-edenred-background p-2 rounded text-xs text-edenred-text font-mono">
            usuario@edenred.com<br />
            edenred123
          </div>
        </div>
      </form>
